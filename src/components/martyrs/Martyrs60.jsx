...
const Martyrs60 = ({ martyrs60prop }) => {

    const [ martyrsData, setmartyrsData ] = useState(martyrs60prop)
    const [ query, setQuery ] = useState("")

    return (
        <div>
            <h1 className='title1401'>کشته شدگان دهه ۶۰</h1>
