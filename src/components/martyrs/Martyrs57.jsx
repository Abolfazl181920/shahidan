...
const Martyrs57 = ({ martyrs57prop }) => {
    const [ martyrsData, setmartyrsData ] = useState(martyrs57prop)
    const [ query, setQuery ] = useState("")

    return (
        <div>
            <h1 className='title1401'>کشته شدگان سال ۵۷ </h1>
